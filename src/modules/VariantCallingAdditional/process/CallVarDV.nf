process CallVarDV {
    ...
    publishDir "$params.outputDir/VariantCalling/VariantsFromDV/gvcf", mode: "copy"
    ...
    path("${outFile2}"), emit: dv_variants_gvcf
    path("${outFile2_index}"), emit: dv_variants_gvcf_tbi
