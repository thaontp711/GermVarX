...
include { Indexing } from './process/Indexing'
...
workflow JointGenotyping {
    ...
    main:
        ...
        if(params.use_genomicsdb){
            ...
            GenomicsDBImport(chr_ch, Indexing.out.gvcf.collect(), Indexing.out.gvcf_tbi.collect())
            ...
            CombineGVCFs(chr_ch, Indexing.out.gvcf.collect(), Indexing.out.gvcf_tbi.collect())
        ...
        doneJointGenotyping = Channel.empty()
                            .mix(GatherVcfs.out.done_gatk_merge_vcf)
